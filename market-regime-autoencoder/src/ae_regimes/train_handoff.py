...
from ae_regimes.train import extract_latent_space, train_autoencoder
...
def main() -> None:
    ...
    model, loss_history = train_autoencoder(features["train"], config)
    ...
    print(f"Final train epoch loss: {loss_history['loss'].iloc[-1]:.6f}")
